...
select billing_country,count(1) as invoice_count from invoice
...
select a1.artist_id, a1.name, count(a1.name) as Total_track_count from
artist a1 join album a2
